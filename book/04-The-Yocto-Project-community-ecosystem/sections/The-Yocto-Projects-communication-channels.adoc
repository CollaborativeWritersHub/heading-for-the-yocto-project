...
The Yocto Project, being an umbrella for different projects, has different mailing lists for each of those projects. The most important mailing lists can be seen at table <<The Yocto Project mailing lists>>.

.The Yocto Project mailing lists
[cols="2*"]
|===
...
Be gentle:: People on the mailing list do not have the duty to help you. When they do it, they are doing in a goodwill.
