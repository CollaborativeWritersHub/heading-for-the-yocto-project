...
So, check your equipment and dive with us!
...
This first dive, oops, chapter, elucidates what the Yocto Project is, what the difference between the Poky and OpenEmbedded-Core build systems is and how all these projects relate to each other.

The choice for a very high abstraction level description is because this may be your very first contact with Yocto Project and the relationship between all project's components is hard to grasp when we look at the Yocto Project from an inner technical perspective.
